...
import requests
import os
from restconf_final import create,delete,status,enable,disable
#######################################################################################
...
roomIdToGetMessages = (
    "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vYmU4NjkyYTAtOGE0ZC0xMWVmLTlhYzgtZWJkNTFkNTg3ZmIw"
)
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    #  e.g.  "/66070123 create"
    if message.startswith("/65070141"):
...
# 6. Complete the code to post the message to the Webex Teams room.
        ...
        #     filename = f"show_run_{65070141}_{10.0.15.183}.txt"
